    ...
    return (
        <div className="bg-[#1F2937] ">
            <div className="flex items-center">
                <div className="bg-[#1F2937] text-[#FFFFFF] text-center flex-1 space-y-1">
                    <h6>CONTACT US</h6>
                ...
                <div className="bg-[#111827] text-[#FFFFFF] flex-1 text-center items-center py-4 space-y-1">
                    <h6>Follow US</h6>
            ...
            <div className="bg-[#151515] text-white text-center">
